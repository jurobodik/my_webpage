...
<br>
[Discovering plausible direct causes of a target variable](https://arxiv.org/abs/2112.10858)  
...
**Abstract**: We consider the problem of learning a set of direct causes of a target variable from an observational joint distribution. Learning causal   directed acyclic graphs (DAGs) is a fundamental problem in science. Several results are known when the full DAG is identifiable from the distribution, such as assuming a nonlinear Gaussian data-generating process. We show conditions under which the set of direct causes is identifiable from the distribution under essentially no assumptions on the data-generating process of the variables other than the target variable. This framework can be beneficial when we are not interested in the full DAG but only in local causal relations around the target variable. It can be an interesting complement to conditional-independence-based methods for orienting some edges in partially oriented graphs. 
We provide two practical algorithms for estimating the direct causes from a finite random sample and show their effectiveness on several benchmark data-sets. 
</div>
<br>
...
- [BIRS: Combining Causal Inference and Extreme Value Theory in the Study of Climate Extremes and their Causes ](http://www.birs.ca/events/2022/5-day-workshops/22w5079) (Presented via Zoom, **Kelowna**,  26.6.2022-1.7.2022) 
...
- [CMStatistics](http://www.cmstatistics.org/RegistrationsV2/CMStatistics2021/viewSubmission.php?in=251&token=p12r7623o22q1oo2p4qrnq17n2s36r1o) (Presented via Zoom, **London**, 18.12.2021 - 20.12.2021)

- [Valpred workshop](http://wintenberger.fr/VALPRED) (Presented in **Aussois**, France, 4.10.2021-7.10.2021) 

- [EVA: Extreme value analysys](https://www.maths.ed.ac.uk/school-of-mathematics/eva-2021) (Presented via Zoom, **Edinburgh**,  5.6.2021-9.6.2021) 
